...
(2, 'inu1.jpg', '今日のランチは美味しかった！', 13),
(2, 'inu2.jpg', '新しいプロジェクトが始まったよ。がんばるぞ！', 2),

-- cherry_bomb (id=3) の投稿
(3,'inu3.jpg', '🌸桜が満開です！', 34),
(3, 'inu4.jpg', 'お気に入りのカフェで一息😊', 26),

-- takeshi_rock (id=4) の投稿
(4,'inu5.jpg', '筋トレ終了！💪',45),
(4, 'inu6.jpg', 'ロックミュージック最高！', 52),

-- yukari_purple (id=5) の投稿
(5, 'inu7.jpg', 'プログラミング楽しいな！', 3),
(5, 'inu8.jpg', '猫の動画を共有します🐱', 5),

-- mako_hello (id=6) の投稿
(6, 'inu9.jpg', 'こんにちは世界！',34),
(6, 'inu10.jpg', '最近読んだ本が面白かった。', 42),

-- shin_chan (id=7) の投稿
(7, 'inu11.jpg', 'お昼寝最高～', 23),
(7, 'inu12.jpg', 'アニメ見てるなう！', 11),

-- ayumi_walk (id=8) の投稿
(8, 'inu13.jpg', '散歩日和です👟', 23),
(8, 'inu14.jpg', '新しいスニーカー買ったよ！', 12),

-- hiroto_sky (id=9) の投稿
(9, 'inu15.jpg', '空がきれいだね。', 23),
(9, 'inu16.jpg', 'ドライブに行きたいな。',66),

-- sakura_blossom (id=10) の投稿
(10, 'inu17.jpg', '🌸春が来た！', 34),
